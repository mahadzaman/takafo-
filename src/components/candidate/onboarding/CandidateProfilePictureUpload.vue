                  ...
                  >
                    ...
                    <div class="upload-prompt">
                      ...
                      <p class="base-body-text-1 text-disabled">
                        .png, .svg, .jpg files are supported (Max. file size is
                        2.0 mb)
                      </p>
                    </div>
                  </div>
...
const onFileSelected = (event: Event): void => {
  ...
  if (file) {
    if (file.size <= 2 * 1024 * 1024 && isValidFileType(file as FileObject)) {
      selectedFile.value = {
        name: file.name,
        size: file.size,
        type: file.type,
      ...
      alert(
        'Invalid file. Only .png, .svg, .jpg files under 2 MB are supported.'
      );
      clearFile();
    }
  }
